...
import com.digigate.engineeringmanagement.configurationmanagement.service.administration.ISubModuleService;
...
public class ConfigSubModuleController {
    ...
    private final ISubModuleService configSubModuleService;

    public ConfigSubModuleController(ISubModuleService configSubModuleService) {
        this.configSubModuleService = configSubModuleService;
    }
    ...
    public ResponseEntity<MessageResponse> updateActiveStatus(@PathVariable Long id,
        ...
        configSubModuleService.updateActiveStatus(id, isActive);
    ...
    public ResponseEntity<PageData> search(@RequestBody @Valid ConfigMenuSearchDto searchDto,
        ...
        return new ResponseEntity<>(configSubModuleService.search(searchDto, pageable), HttpStatus.OK);
    }

    @GetMapping("/{id}")
    public ConfigSubModuleResponseDto getSingle(@PathVariable Long id) {
        return configSubModuleService.getSingle(id);
    }
}
