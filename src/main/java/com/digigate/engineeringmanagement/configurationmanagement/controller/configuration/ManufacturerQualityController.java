...
@RestController
@RequestMapping("/api/config/quality/manufacturer")
public class ManufacturerQualityController {
    private final ManufacturerService manufacturerService;

    public ManufacturerQualityController(ManufacturerService manufacturerService) {
    ...
    public ResponseEntity<MessageResponse> updateActiveStatus(@PathVariable Long id,
        ...
        manufacturerService.updateActiveStatus(id, isActive, VendorWorkFlowType.QUALITY);
    ...
    ApprovalRequestDto approvalRequestDto) {
        manufacturerService.makeDecision(id, approvalRequestDto, VendorWorkFlowType.QUALITY);
    ...
    QualitySaveValidityDateReqDto qualitySaveValidityDateReqDto) {
        return ResponseEntity.ok(new MessageResponse(VALIDITY_DATE_ADDED_SUCCESSFULLY,  manufacturerService.saveValidityDate(id, qualitySaveValidityDateReqDto).getId()));
    }
}
