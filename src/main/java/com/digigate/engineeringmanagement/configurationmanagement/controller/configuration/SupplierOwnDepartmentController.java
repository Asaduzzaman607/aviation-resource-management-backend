...
@RestController
@RequestMapping("/api/material-management/config/supplier/own_department")
public class SupplierOwnDepartmentController {

    private final SupplierService supplierService;

    public SupplierOwnDepartmentController(SupplierService supplierService) {
    ...
    public ResponseEntity<MessageResponse> updateActiveStatus(@PathVariable Long id,
        ...
        supplierService.updateActiveStatus(id, isActive, VendorWorkFlowType.OWN_DEPARTMENT);
    ...
    ApprovalRequestDto approvalRequestDto) {
        supplierService.makeDecision(id, approvalRequestDto, VendorWorkFlowType.OWN_DEPARTMENT);
