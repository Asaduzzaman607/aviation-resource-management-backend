...
@RestController
@RequestMapping("/api/procurement/audit/parts-invoice")
public class ProcurementPartsInvoiceAuditController {
    private final PartsInvoicesService partsInvoicesService;

    public ProcurementPartsInvoiceAuditController(PartsInvoicesService partsInvoicesService) {
    ...
    public ResponseEntity<String> makeDecision(@PathVariable Long id,
        ...
        partsInvoicesService.makeDecision(id, approvalRequestDto, RfqType.PROCUREMENT , PartsInVoiceWorkFlowType.AUDIT);
