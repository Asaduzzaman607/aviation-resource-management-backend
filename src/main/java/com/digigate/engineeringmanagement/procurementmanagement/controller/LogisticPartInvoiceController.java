...
@RestController
@RequestMapping("/api/logistic/own_department/parts-invoice")
public class LogisticPartInvoiceController {
    private final PartsInvoicesService partsInvoicesService;

    public LogisticPartInvoiceController(PartsInvoicesService partsInvoicesService) {
    ...
    public ResponseEntity<String> makeDecision(@PathVariable Long id,
        ...
        partsInvoicesService.makeDecision(id, approvalRequestDto, RfqType.LOGISTIC ,PartsInVoiceWorkFlowType.OWN_DEPARTMENT);
