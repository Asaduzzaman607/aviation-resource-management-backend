...
@RestController
@RequestMapping("/api/procurement/vendor/quotations")
public class ProcurementVendorQuotationController {

    private final VendorQuotationService vendorQuotationService;

    public ProcurementVendorQuotationController(VendorQuotationService vendorQuotationService) {
    ...
    public ResponseEntity<MessageResponse> create(@Valid @RequestBody VendorQuotationDto vendorQuotationDto) {
        vendorQuotationDto.setRfqType(RfqType.PROCUREMENT);
    ...
    public ResponseEntity<PageData> search(@RequestBody @Valid VendorQuotationSearchDto vendorQuotationSearchDto, @PageableDefault(
        ...
        vendorQuotationSearchDto.setRfqType(RfqType.PROCUREMENT);
    ...
    public Pair<String, List<CsQuotationViewModel>> getAll(@PathVariable Long id,
        ...
        return vendorQuotationService.findVendorQuotationByType(type, id);
    }
