...
@RestController
@RequestMapping("/api/logistic/quote-requests")
public class LogisticQuoteRequestController {
    private final QuoteRequestService quoteRequestService;

    public LogisticQuoteRequestController(QuoteRequestService quoteRequestService) {
        this.quoteRequestService = quoteRequestService;
    }

    @PostMapping
    public ResponseEntity<MessageResponse> create(@Valid @RequestBody RfqRequestDto rfqRequestDto) {
        rfqRequestDto.setRfqType(RfqType.LOGISTIC);
    ...
    public ResponseEntity<MessageResponse> updateActiveStatus(@PathVariable Long id,
        ...
        quoteRequestService.updateActiveStatus(id, isActive, RfqType.LOGISTIC);
    ...
    public ResponseEntity<String> makeDecision(@PathVariable Long id, @Valid @RequestBody ApprovalRequestDto approvalRequestDto) {
        quoteRequestService.makeDecision(id, approvalRequestDto, RfqType.LOGISTIC);
