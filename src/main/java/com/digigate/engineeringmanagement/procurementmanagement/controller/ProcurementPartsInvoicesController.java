...
@RestController
@RequestMapping("/api/procurement/own_department/parts-invoice")
public class ProcurementPartsInvoicesController {
    private final PartsInvoicesService partsInvoicesService;

    public ProcurementPartsInvoicesController(PartsInvoicesService partsInvoicesService) {
    ...
    public ResponseEntity<MessageResponse> create(@Valid @RequestBody PartsInvoicesDto partsInvoicesDto) {
        ...
        partsInvoicesDto.setPartsInVoiceWorkFlowType(PartsInVoiceWorkFlowType.OWN_DEPARTMENT);
    ...
    public ResponseEntity<PageData> search(@RequestBody @Valid PISearchDto searchDto, @PageableDefault(
        ...
        searchDto.setPartsInVoiceWorkFlowType(PartsInVoiceWorkFlowType.OWN_DEPARTMENT);
    ...
    public ResponseEntity<MessageResponse> updateActiveStatus(@PathVariable Long id,
        ...
        partsInvoicesService.updateActiveStatus(id, isActive, PartsInVoiceWorkFlowType.OWN_DEPARTMENT);
    ...
    public ResponseEntity<String> makeDecision(@PathVariable Long id,
        ...
        partsInvoicesService.makeDecision(id, approvalRequestDto, RfqType.PROCUREMENT, PartsInVoiceWorkFlowType.OWN_DEPARTMENT);
