...
@RestController
@RequestMapping("/api/procurement/part-orders")
public class ProcurementPartOrderController {
    private final PartOrderService partOrderService;

    public ProcurementPartOrderController(PartOrderService partOrderService) {
    ...
    public ResponseEntity<MessageResponse> create(@Valid @RequestBody PoInternalDto poInternalDto) {
        poInternalDto.setRfqType(RfqType.PROCUREMENT);
    ...
    public ResponseEntity<MessageResponse> update(@Valid @RequestBody PoInternalDto poInternalDto, @PathVariable Long id) {
        poInternalDto.setRfqType(RfqType.PROCUREMENT);
        return ResponseEntity.ok(new MessageResponse(ApplicationConstant.UPDATED_SUCCESSFULLY_MESSAGE, partOrderService.update(poInternalDto, id, ApprovalStatusType.PURCHASE_ORDER).getId()));
    }
    ...
    public ResponseEntity<MessageResponse> updateActiveStatus(@PathVariable Long id,
        ...
        partOrderService.updateActiveStatus(id, isActive, RfqType.PROCUREMENT);
    ...
    public ResponseEntity<String> makeDecision(@PathVariable Long id, @Valid @RequestBody ApprovalRequestDto approvalRequestDto) {
        partOrderService.makeDecision(id, approvalRequestDto, RfqType.PROCUREMENT);
    ...
    public ResponseEntity<MessageResponse> create(@Valid @RequestBody PartOrderListDto partOrderListDto) {
        partOrderListDto.setRfqType(RfqType.PROCUREMENT);
