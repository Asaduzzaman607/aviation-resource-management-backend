...
@RestController
@RequestMapping("/api/procurement/comparative-statements/final-management")
public class ProcurementCsFinalWorkFlowController {
    ...
    public ProcurementCsFinalWorkFlowController(ComparativeStatementService comparativeStatementService, CsUtilService csUtilService) {
    ...
    public ResponseEntity<MessageResponse> makeDecisionToFinal(@PathVariable Long id, @Valid @RequestBody ApprovalRequestDto approvalRequestDto) {
        csUtilService.decision(id, approvalRequestDto, CsWorkflowType.CS_FINAL, RfqType.PROCUREMENT);
