...
public class ErrorId {
    ...
    public static final String CAN_NOT_CREATE_ISSUE_BECAUSE_THIS_SERIAL_HAS_ALREADY_ISSUED = "issue001";
    /**
    ...
    public static final String SERIAL_CREATION_ON_STATUS = "storepartserial004";
    ...
    public static final String INVALID_CHECK_TYPE = "ctype101";
    public static final String PAYMENT_CURRENCY_PAYMENT_MODE_MANDATORY = "pi0002";
    public static final String CLIENT_NAME_ALREADY_EXIST = "cl001";
    public static final String VENDOR_VALIDITY_DATE_MISSING = "qv0001";
    /**
    ...
    public static final String GRN_NO_MUST_NOT_BE_NULL ="grn001";
}
