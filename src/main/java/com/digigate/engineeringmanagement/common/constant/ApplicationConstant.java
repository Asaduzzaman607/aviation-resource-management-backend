...
public class ApplicationConstant {
    ...
    public static final String DUTY_FEE_ITEM = "dutyFeeItem";
    ...
    public static final String PARTS_INVOICE_ITEM = "partsInvoiceItem";
    public static final String PARTS_INVOICE = "partsInvoice";
